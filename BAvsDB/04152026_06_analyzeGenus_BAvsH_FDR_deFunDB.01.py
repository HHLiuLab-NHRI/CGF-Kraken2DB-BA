...
TASKS = [
    {
        'label': 'R1',
        'input_file': '../k2GenusSummary_R1_deFunDB/genusAverage.csv',
        'output_dir': '../Geni_Analyses_TwoGroup_BA_H_FDR_deFunDB.01/R1'
    },
    {
        'label': 'R2',
        'input_file': '../k2GenusSummary_R2_deFunDB/genusAverage.csv',
        'output_dir': '../Geni_Analyses_TwoGroup_BA_H_FDR_deFunDB.01/R2'
    }
]
